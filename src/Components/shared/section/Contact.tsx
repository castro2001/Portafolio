...
import { openSansFont, PoppinsFont } from "@/src/fonts/fonts";
    ...
    return(
      <>
        ...
        <div className="max-w-4xl mx-auto text-center lg:pt-0 pt-[30px]">
          <h2 className={`lg:text-[30px] text-[28px] capitalize  font-bold mb-6 ${PoppinsFont.className}`}>
          ...
          <p className={`text-xl mb-8 ${openSansFont.className} ${currentTheme ==="dark"  ? 'text-gray-400' : 'text-gray-600'}`}>
            {t.contact.description}
          </p>
          <a 
            href="mailto:jordanlino83@gmail.com"
